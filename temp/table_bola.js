...
<tr class="h-18 border-b border-coolGray-100">
    ...
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">#nama#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#nama_club#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#liga#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#tahun_berdiri#</th>
     <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#stadion#</th>
     <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#manajer#</th>
     <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#logo#</th>
    ...
    <th class="whitespace-nowrap px-4 bg-white text-center">
      <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
        ...
        |
          <a type="button" href="detail.html?pemainId=#detail#"> Detail
        </a>
    </th>
    <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
